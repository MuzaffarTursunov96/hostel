...
class SettingsPage(QWidget):
    ...
    def build_ui(self):
        ...
        # ===== USER SETTINGS =====
        user_lbl = QLabel(t("user_settings"))
        user_lbl.setStyleSheet("font-size:18px;font-weight:600;")
        ...
        lang_lbl.setStyleSheet("font-size:18px;font-weight:600;")
    ...
    def build_branch_section(self):
        ...
        title = QLabel(t("branch_management"))
